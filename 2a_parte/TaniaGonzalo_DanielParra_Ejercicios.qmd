...
Y el alineamiento progresivo se muestra en la figura @fig-ej2-7

![Alineamiento progresivo obtenido a partir de alineamientos 2 a 2 con matriz BLOSUM62](Ej2/Alineamiento_Progresivo_BLOSUM62.jpeg){#fig-ej2-7}
...
#### Generación del logo de secuencias
...
##### Logo del alineamiento progresivo del alineamiento por pares mediante la BLOSUM40
...
##### Logo del alineamiento progresivo del alineamiento por pares mediante la BLOSUM62
...
##### Logo del alineamiento múltiples (MSA) por Clustal Omega
