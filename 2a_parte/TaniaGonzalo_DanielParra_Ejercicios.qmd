...
ggseqlogo(matriz_frec, 
  ...
  labs(
    title = "Logo del alineamiento progresivo con la Blosum40",
...
```{r}
# 1. Cargar el alineamiento (formato FASTA) 
alineamiento <- readAAStringSet("Alineamiento_final_BLOUSUM62.fa")  
...
ggseqlogo(matriz_frec, 
  ...
  labs(
    title = "Logo del alineamiento progresivo con la Blosum62",
    x = "Posición en el alineamiento",
    y = "Bits de información"
  ) +
  theme_classic() +               # Estilo del gráfico
...
#### Escogemos un logo/alineamiento:
