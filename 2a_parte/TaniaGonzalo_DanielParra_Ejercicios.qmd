...
El uso de diferentes matrices de sustitución afecta la conservación y la variabilidad en el alineamiento. BLOSUM40 favorece secuencias más distantes, mientras que BLOSUM62 es más adecuado para secuencias cercanas. Además, hemos podido obsrvar como los alineamientos manuales tienden a reflejar las decisiones del usuario en la construcción del alineamiento (por ejemplo, la introducción de gaps puede ser en ocasiones arbitraria), lo que puede generar patrones de conservación diferentes a los obtenidos mediante métodos automáticos como Clustal Omega.
